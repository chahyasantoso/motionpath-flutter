...
void main() {
  test('canonical v4 fixture has no fatal diagnostics and preserves coverage', () {
    ...
    expect(project.motions.map((MotionPathMotion motion) => motion.id), <String>[
      'scroll-scrub',
      'time-loop',
      'time-paused',
      'manual-scrubber',
    ...
    expect(project.motions[1].tracks[2].keyframes.containsKey('--card-size'), isTrue);
