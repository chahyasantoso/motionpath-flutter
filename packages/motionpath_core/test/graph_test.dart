...
void main() {
  ...
  test('diagnoses cycles and missing sources', () {
    ...
    expect(
      ...
      containsAll(<String>['track-observations', 'track-observations-cycle']),
    );
  ...
  test('rejects duplicate nodes, self cycles, and duplicate edges', () {
    ...
    final Iterable<String> codes = graph.errors.map(
      (MotionPathDiagnostic error) => error.code,
    );
