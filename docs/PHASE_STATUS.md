...
Updated 2026-08-03 against `main` after PRs #146 through #149 merged green.
...
| 4 Dynamic children and spawn lifecycle | Complete | PRs #81 through #86, #147, and #149 merged; deterministic ordering, invariant wrapper identity, cache replacement lifecycle, front-most hit testing, reflow/drain, and reusable spawn rendering are complete. | Closed |
...
| 9 Release hardening | Deferred | Audit implementation workstreams A through D are complete in PRs #148 and #149. Publishing, metadata, dry-runs, benchmarks, security evidence, and tagging are deferred until further notice. | On hold |

## Operating rule

A phase is complete only after its PR is green, merged into `main`, and its exit criteria are recorded here. Deferred work remains explicitly on hold.
