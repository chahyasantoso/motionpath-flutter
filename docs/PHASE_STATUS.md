...
| 2 Immutable patch contract | Active | PR #69 merged; optional interest-scoped composition and regression coverage now live. Remaining key taxonomy, normalizer boundary, mutation coverage, and complete plugin parity work stays in this phase. | Must finish every Phase 2 task and pass CI before Phase 3 |
