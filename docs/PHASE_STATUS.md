...
| 5 Scroll capabilities | Active | This PR adds arbitrary pin host layout from `MotionPathViewportSample.paintOffset` and binding listeners. | Open. Snap remains deferred; needs green CI and integration coverage |
