...
| 4 Dynamic children and spawn lifecycle | Active | PR #81 ordering and top-most-first helper merged; PR #82 removes Spiral's redundant setState. This slice adds restart-wave and shared-ticker lifecycle edge-case coverage. | Open. Reflow, drain, ordering, hit testing, and lifecycle cleanup still need full exit evidence |
