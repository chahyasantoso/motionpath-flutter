...
| 3 Shared Flutter renderer | Active | PRs #73, #74, and #75 merged. This slice adds one shared z/perspective/3D matrix for widget and painter paths, with tests. Still open: claimed-but-unsupported reporting, image cache and disposal, performance tests, and Spiral demo migration. | Open. Must finish every renderer task and pass CI before Phase 4 |
