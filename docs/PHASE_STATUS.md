...
Updated 2026-08-03 against `main` after PR #144 merged green.
...
| 4 Dynamic children and spawn lifecycle | Complete | PRs #81 through #86 merged; deterministic ordering, host paint order, front-most hit testing, reflow/drain, lifecycle coverage, and Spiral renderer audit PR #144 are complete. | Closed |
...
| 9 Release hardening | Partial | The full JS demo inventory is now ported through PR #144, and the launcher reaches all nine demos. Remaining work is publish/security/API-doc, benchmark, and clean-package release evidence tracked in `docs/RELEASE_CHECKLIST.md`. | Open |
