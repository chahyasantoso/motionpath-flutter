...
| 6 Cross-repository parity | Partial | PRs #91 through #105 cover authored payloads, path behavior, triggers, repeat boundaries, anchors, validation diagnostics, lifecycle controls, completion events, and plugin edge contracts. | Open. See `docs/PHASE_6_ACCEPTANCE.md` |
